...
def set_quantity_and_add_to_cart(quantity=1):
    ...
    # New actions: Find and type reference, then click next
    ...
    if referentie_location:
        ...
        pyautogui.write("Terry - the Hive", interval=0.1)
        print("✅ Typed reference: Terry - the Hive.")
    else:
...
if __name__ == "__main__":
    ...
    set_quantity_and_add_to_cart(quantity)
